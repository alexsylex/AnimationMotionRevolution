...
namespace RE
{
	...
	public:
		...
		inline hkVector4 GetPosition(bool a_applyCenterOffset = true) const 
		{
			hkVector4 pos;
			GetPositionImpl(pos, a_applyCenterOffset);
			return pos;
		}

		void SetWantedState()
		{
			if (wantState != hkpCharacterStateType::kTotal)
			{
				context.currentState = wantState;
				wantState = hkpCharacterStateType::kTotal;
			}
		}
